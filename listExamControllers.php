		...
		<div class="col-sm-4">
			<div class="page-header float-left">
				<div class="page-title">
					<h1>All Exam Controllers List</h1>
				</div>
			</div>
		</div>            
	</div>
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<?php
						...
						$retrieve_users = $retrieve_users_obj->retrieveByUserType('users_credentials', 2, 'id', 'ASC');
					...
					<tr>
						...
						<td class="subject-delete" >
							...
							<button type="button" class="deleteButtonIcon" data-toggle="modal" data-target="#deleteExamControllerConfirmation">
...
<!-- Modal -->
<div class="modal fade" id="deleteExamControllerConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<form action="deleteExamController.php" method="post">
