                ...
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">                       
                        <h4 class="mb-0">
                            <span class="count">
								<?php 
									$super_admin_count_obj = new retrieveData;
									$super_admin_count = count($super_admin_count_obj->retrieveByUserType(
										'users_credentials',
										2,
										'user_type'
									));
								
									echo $super_admin_count;
								?>
							</span>
                        </h4>
                        <p class="text-light">
							<?php 
								if($super_admin_count>1){
									echo "Registered Super Admins";
								}
								else{
									echo "Registered Super Admin";
								}
							?>
						</p>
                    </div>
