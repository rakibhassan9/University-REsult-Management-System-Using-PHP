				...
				<tbody>
					...
					<tr>
						...
						<td class="subject-delete" >
							...
							<button type="button" class="deleteButtonIcon" data-toggle="modal" data-target="#deleteStudentConfirmation">
...
<!-- Modal -->
<div class="modal fade" id="deleteStudentConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
