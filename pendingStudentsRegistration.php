		...
		<div class="col-sm-4">
			<div class="page-header float-left">
				<div class="page-title">
					<h1>Pending Student's Registration</h1>
				</div>
			</div>
		</div>            
	</div>
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th scope="col" class="subject-delete">Approve</th>
				...
				<tbody>
					...
					<?php
						...
						$retrieve_users = $retrieve_users_obj->retrieveByUserVerification('users_credentials', 4, 0, 'id', 'ASC');
					...
					<tr>
						...
						<td class="subject-delete" >
							...
							<button type="button" class="approveButtonIcon" data-toggle="modal" data-target="#approveTeacherConfirmation">
...
<!-- Modal -->
<div class="modal fade" id="approveTeacherConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Approve Teacher's Registration?</h5>
      ...
      <div class="modal-footer">
		...
		<form action="approveStudent.php" method="post">
			...
			<input type="hidden" name="redirectPage" value="pendingTeachersRegistraion">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<form action="deleteStudent.php" method="post">			
			<input type="hidden" class="postId" name="id" value="">
			<input type="hidden" name="redirectPage" value="pendingStudentsRegistraion">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.approveButtonIcon').click(function(){
