		...
		<div class="col-sm-4">
			<div class="page-header float-left">
				<div class="page-title">
					<h1>Pending Teacher's Registration</h1>
				</div>
			</div>
		</div>            
	</div>
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<?php
						...
						$retrieve_users = $retrieve_users_obj->retrieveByUserVerification('users_credentials', 3, 0, 'id', 'ASC');
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<form action="approveTeacher.php" method="post">
